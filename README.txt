...
|_[Directory]-FortiSLLVPN_SOUTH_AFRICA
	...
	|_MaltegoScans (Main folder holding the maltego scans, to download maltego visit: https://www.maltego.com/downloads/)
		...
		|_[File]-one.mtgl (Maletgo graph mapping 49 IPv4 addresses back to data  and companies. NOTE:scans mostly tie IP addresses to AFRINIC)
		|_[File]-two.mtgl (Maletgo graph mapping 49 IPv4 addresses back to data  and companies. NOTE:scans mostly tie IP addresses to AFRINIC)
		|_[File]-three.mtgl (Maletgo graph mapping 49 IPv4 addresses back to data  and companies. NOTE:scans mostly tie IP addresses to AFRINIC)
		|_[File]-four.mtgl (Maletgo graph mapping 49 IPv4 addresses back to data  and companies. NOTE:scans mostly tie IP addresses to AFRINIC)
		|_[File]-five.mtgl (Maletgo graph mapping 49 IPv4 addresses back to data  and companies. NOTE:scans mostly tie IP addresses to AFRINIC)
		|_[File]-six.mtgl (Maletgo graph mapping 49 IPv4 addresses back to data  and companies. NOTE:scans mostly tie IP addresses to AFRINIC)
